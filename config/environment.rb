...
Rails::Initializer.run do |config|
  ...
  config.gem 'will_paginate', :version => '~> 2.3.15', :lib => 'will_paginate', :source => 'http://gems.github.com'
  config.gem 'whenever', :version => '0.6.2'
  config.gem 'fastercsv', :version => '1.5.4'
  config.gem 'twitterstream', :version => '0.2.1'
