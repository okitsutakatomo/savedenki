...
# mimiuchi
##########################################################
set :application, "savedenki_staging"
...
#set :whenever_update_flags, "--update-crontab #{whenever_identifier} --set environment=#{rails_env}"
#set :whenever_clear_flags, "--clear-crontab #{whenever_identifier} --set environment=#{rails_env}"
